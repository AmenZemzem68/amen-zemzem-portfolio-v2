    ...
    <section className="pb-16 lg:py-24">
      <div className="container">
        <div className="flex justify-center">
          <p className="uppercase font-semibold tracking-widest bg-gradient-to-r from-[#49b79e] to-[#804DEE] text-transparent bg-clip-text text-center">
            Real-world Results
          </p>
        </div>
            ...
            >
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                <div className="lg:pb-16">
                  <div className="bg-gradient-to-r from-[#49b79e] to-[#804DEE] inline-flex gap-2 font-bold uppercase tracking-widest text-sm text-transparent bg-clip-text">
